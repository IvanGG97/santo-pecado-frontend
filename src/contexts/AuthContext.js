...
//         const authToken = localStorage.getItem('authToken');
//         if (!authToken) return null;
//         // Si el token es válido, lo decodifica y devuelve los datos del usuario
//         return jwtDecode(JSON.parse(authToken).access);
//     } catch (error) {
//         // Si el token está malformado o es inválido, lo limpia y devuelve null
//         console.error("No se pudo decodificar el token del localStorage.", error);
//         localStorage.removeItem('authToken');
//         return null;
//     }
...
//                 // Paso CRÍTICO: Guardar el token para que el interceptor lo encuentre
//                 localStorage.setItem('authToken', JSON.stringify(data));
//                 console.log("AuthContext: Token guardado exitosamente en localStorage.");
