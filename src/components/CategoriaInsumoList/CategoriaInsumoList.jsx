...
const CategoriaInsumoList = () => {
    ...
    const handleDelete = (categoria) => {
        ...
        Swal.fire({
            ...
            text: `Se eliminará "${categoria.categoria_insumo_nombre}".`, // Mensaje más simple aquí
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    if (error.response && error.response.status === 400 && error.response.data.insumos) {
                        // Si es el error 400 y viene la lista de insumos
                        ...
                        console.error("Error al eliminar categoría:", error); // Loguea el error completo
