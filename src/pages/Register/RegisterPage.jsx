            ...
            <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
                ...
                <input 
                    ...
                    {...register("username", { 
                        ...
                        maxLength: { value: 100, message: "El usuario no puede tener más de 100 caracteres" } 
                    })} 
                />
                ...
                <input 
                    ...
                    {...register("lastName", { 
                        ...
                        maxLength: { value: 100, message: "El apellido no puede tener más de 100 caracteres" } 
                    })} 
                />
                <small className={styles.charCounter}>{lastName.length} / 100</small>
                {errors.lastName && <p className={styles.error}>{errors.lastName.message}</p>}

                {/* --- DNI (VALIDACIÓN ACTUALIZADA A 6 MILLONES) --- */}
                ...
                <input 
                    ...
                    {...register("dni", {
                        ...
                        maxLength: { value: 8, message: "El DNI no puede tener más de 8 dígitos" },
                        validate: { 
                            // Parseamos el string a entero decimal (base 10) y comparamos
                            minNumber: v => parseInt(v, 10) > 6000000 || "El DNI no es válido (debe ser mayor a 6 millones)"
                        }
                    })} 
                />
                ...
                <input 
                    ...
                    {...register("telefono", {
                        ...
                        maxLength: { value: 15, message: "El teléfono no puede tener más de 15 caracteres" },
                        pattern: { 
                            value: /^[0-9+\s]+$/,
                            message: "Número de teléfono no válido (solo números, + y espacios)"
                        }
                    })} 
                />
